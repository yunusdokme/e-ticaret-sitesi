...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Kredi kartı bilgilerini işleme koyun ve gerekli işlemleri yapın

    // İşlemin tamamlandığını belirten bir mesaj görüntüleyin
    echo '<script>alert("Ödemeniz Tamamlandı");</script>';

    // 2 saniye sonra otomatik olarak home.php'ye yönlendirme yapın
  ...
  <div class="col-75">
    ...
    <form method="post">
        ...
        <div class="row">
          ...
          <div class="col-50">
            <h3>Ödeme</h3>
            <label for="fname">Kabul edilen Kart </label>
        ...
        <input type="submit" value="Ödemeyi Sonlandır" class="btn">
      </form>
    </div>
  </div>
